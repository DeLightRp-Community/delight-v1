...
Config.Locations =  {
	...
	['Smelter'] = {	name = "Mining Process", location = vector3(1112.29, -2009.9, 31.46), spr = 527, col = 81, blipTrue = true }, -- The location of the smelter
...
Config.Items = {
    ...
    items = {
	[1] = { name = "water_bottle", price = 50, amount = 100, info = {}, type = "item", slot = 1, },
	[2] = { name = "sandwich", price = 60, amount = 250, info = {}, type = "item", slot = 2, },
	[3] = { name = "drill",	price = 700, amount = 100, info = {}, type = "item", slot = 3, }, 
	[4] = { name = "handdrill",	price = 500, amount = 100, info = {}, type = "item",	slot = 4, },
	[5] = { name = "drillbit", price = 100, amount = 100,	info = {}, type = "item", slot = 5, }, }		
}
