local Translations = {
    ...
    info = {
        ...
        bleed_out = 'YOU WILL BLEED OUT IN: ~r~%{time}~s~ SECONDS, CALL MEDICS WITH /103',
        bleed_out_help = 'YOU WILL BLEED OUT IN: ~r~%{time}~s~ SECONDS, YOU CAN BE HELPED CALL /103',
        ...
        paleto_hospital = "The Bay Care Center",
