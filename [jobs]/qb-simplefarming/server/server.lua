...
RegisterServerEvent('qb-simplefarming:cowkilling', function()
    ...
    TriggerClientEvent('QBCore:Notify', source, "Gathered skinned the cow for 1 leather")
end)
...
RegisterNetEvent('qb-simplefarming:slayreward', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
    Player.Functions.AddItem('raw_bacon', 1)
    Player.Functions.AddItem('raw_ham', 1)
    Player.Functions.AddItem('raw_pork', 1)
    Player.Functions.AddItem('raw_sausage', 1)
    ...
    TriggerClientEvent('QBCore:Notify', source, "You Gather some leather")
end)
