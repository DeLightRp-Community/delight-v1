...
Config.SkillBar = "qb-skillbar"                                                     -- np-skillbar / qb-skillbar / reload-skillbar
...
Config.ItemNecessario2 = "ferro" -- Item 2 to upgrade
Config.QuantidadeNecessariaLevel2 = 30  -- Required amount of both items to upgrade to level 2
Config.QuantidadeNecessariaLevel3 = 60 -- Required amount of both items to upgrade to level 3
Config.QuantidadeNecessariaLevel4 = 90 -- Required amount of both items to upgrade to level 4
Config.QuantidadeNecessariaLevel5 = 120 -- Required amount of both items to upgrade to level 5
...
Config.TargetSellMinerLocation = vector3(1127.88, 2644.86, 37.0)  -- Location of sell, you need to change on Config.LocalizacaoPedShop too
...
Config.QBmenuEnvolveTxtLevel2   = "You need: <br> 30x Stone <br> 1x Pickaxe Level 1 <br> 30x Iron"
Config.QBMenuEnvolveLevel3      = "Upgrade to level 3"
Config.QBmenuEnvolveTxtLevel3   = "You need: <br> 60x Stone <br> 1x Pickaxe Level 2 <br> 60x Iron"
Config.QBMenuEnvolveLevel4      = "Upgrade to level 4"
Config.QBmenuEnvolveTxtLevel4   = "You need: <br> 90x Stone <br> 1x Pickaxe Level 3 <br> 90x Iron"
Config.QBMenuEnvolveLevel5      = "Upgrade to level 5"
Config.QBmenuEnvolveTxtLevel5   = "You need: <br> 120x Stone <br> 1x Pickaxe Level 4 <br> 120x Iron"
...
Config.PedListMineiros = {                                              -- Peds that will be spawned in
    ...
    },
    {
        ...
        coords = vector3(1127.88, 2644.86, 37.0),         
        heading = 357.82,
        gender = "male",
        scenario = "WORLD_HUMAN_STAND_MOBILE_UPRIGHT" 
    },
