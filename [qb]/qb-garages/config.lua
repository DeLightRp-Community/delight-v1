...
Garages = {
    ...
    ['Medic'] = {
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(319.57, -584.03, 28.8, 338.05),
            vector4(322.98, -585.3, 28.8, 335.74),
            vector4(326.25, -586.7, 28.8, 340.75),
            vector4(329.48, -587.88, 28.8, 341.02),
            vector4(332.61, -589.14, 28.8, 339.75),
    ...
    ['wuchang'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(-843.98321533204, -773.51550292968),
                vector2(-844.59582519532, -744.56298828125),
                vector2(-807.35522460938, -744.6577758789),
                vector2(-807.43280029296, -773.55346679688)
            },
            ['minZ'] = 18.50,
            ['maxZ'] = 27.20
        },
        label = 'Wuchang Parking',
        showBlip = true,
        blipcoords = vector3(-841.89, -760.65, 22.05),
        blipName = 'Public Parking',
        blipNumber = 357,
        type = 'public',
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-841.99, -760.63, 22.05, 268.25),
            vector4(-841.89, -764.23, 21.67, 243.99),
            vector4(-841.54, -768.09, 21.33, 257.2),
            vector4(-841.29, -771.81, 21.02, 270.96),
            vector4(-828.77, -771.71, 21.02, 89.25),
            vector4(-828.89, -768.02, 21.33, 89.7),
            vector4(-828.88, -764.26, 21.66, 88.96),
            vector4(-828.74, -760.49, 22.04, 89.53),
            vector4(-828.76, -756.94, 22.37, 86.68),
            vector4(-822.74, -757.05, 22.35, 269.87),
            vector4(-823.01, -760.77, 22.0, 271.67),
            vector4(-823.19, -764.55, 21.63, 266.22),
            vector4(-822.99, -768.17, 21.32, 264.8),
            vector4(-809.23, -768.1, 21.32, 85.92),
            vector4(-809.63, -764.28, 21.65, 84.3),
            vector4(-809.6, -760.49, 22.01, 86.58),
            vector4(-809.51, -756.95, 22.34, 84.46),
            vector4(-809.62, -753.36, 22.68, 86.23),
        }
    },
}
