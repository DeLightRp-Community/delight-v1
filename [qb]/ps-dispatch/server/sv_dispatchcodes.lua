...
dispatchCodes = {
	...
	["911call"] =  {displayCode = '911', description = "911 Call", radius = 0, recipientList = {'police'}, blipSprite = 480, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false"},
	["311call"] =  {displayCode = '103', description = "103 Call", radius = 0, recipientList = {'ambulance'}, blipSprite = 480, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false"},
	["officerdown"] =  {displayCode = '10-35', description = "Officer Down", radius = 15.0, recipientList = {'police', 'ambulance'}, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton", offset = "false"},
	["emssdown"] =  {displayCode = '10-12', description = "EMS Down", radius = 15.0, recipientList = {'ambulance'}, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton", offset = "false"},
	["uscgsdown"] =  {displayCode = '10-12', description = "EMS Down", radius = 15.0, recipientList = {'police', 'ambulance'}, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton", offset = "false"},
	["shotfire"] =  {displayCode = '10-99', description = "Shot Fire", radius = 15.0, recipientList = {'police'}, blipSprite = 526, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "panicbutton", offset = "false"},
	...
	["storesaferobbery"] =  {displayCode = '10-90', description = "Store Safe Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 52, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	...
	["vanrobberyhack"] =  {displayCode = '10-90', description = "Security Van Hack Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 484, blipColour = 39, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false"},
	["truckrobbery"] =  {displayCode = '10-90', description = "Security Van Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 67, blipColour = 59, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false"},
	...
	["hunting"] =  {displayCode = '10-90', description = "illegal Hunting", radius = 0, recipientList = {'police'}, blipSprite = 436, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false"},
	["mining"] =  {displayCode = '10-90', description = "Illegal Mining", radius = 0, recipientList = {'police'}, blipSprite = 436, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false"},
	["bobcatrobbery"] = {displayCode = '10-90', description = "Bobcat Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 500, blipColour = 2, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false"},
}
