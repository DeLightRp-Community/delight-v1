...
dispatchCodes = {
	...
	["311call"] =  {displayCode = '103', description = "103 Call", radius = 0, recipientList = {'ambulance'}, blipSprite = 480, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false"},
