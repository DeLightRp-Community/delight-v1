RegisterNetEvent('qb-admin:server:name', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) name to %s %s",
...
RegisterNetEvent('qb-admin:server:food', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) hunger to %s",
...
RegisterNetEvent('qb-admin:server:water', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) thirst to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:stress', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) stress to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:armor', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) armor to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:phone', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) phone number to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:craftingrep', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) craftingrep to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:dealerrep', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) dealerrep to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:cash', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) cash to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:bank', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) bank to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
...
RegisterNetEvent('qb-admin:server:job', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) job to %s %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, NewInfo[1], NewInfo[2]))
...
RegisterNetEvent('qb-admin:server:gang', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) gang to %s %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, NewInfo[1], NewInfo[2]))
...
RegisterNetEvent('qb-admin:server:radio', function(Target, Input)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'admin', 'Admin menu', 'pink', string.format("**%s** (CitizenID: %s | ID: %s) - Changed **%s** (CitizenID: %s | ID: %s) radio to %s",
    GetPlayerName(src), Player.PlayerData.citizenid, src, GetPlayerName(Target.id), TargetInfo.PlayerData.citizenid, Target.id, Input))
