...
RegisterNetEvent('consumables:client:Cokebaggy', function()
    ...
    QBCore.Functions.Progressbar("snort_coke", "Quick sniff..", math.random(5000, 8000), false, true, {
        ...
        AlienEffect()
        --exports['ps-buffs']:AddBuff("super-armor", 150000)
        exports['ps-buffs']:AddArmorBuff(30000, 10)
        exports['ps-buffs']:AddBuff("intelligence", 300000)
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:oxy', function()
    QBCore.Functions.Progressbar("use_oxy", "Healing", 2000, false, true, {
		...
		exports['ps-buffs']:AddBuff("super-health", 150000)
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "mp_suicide", "pill", 1.0)
        QBCore.Functions.Notify("Canceled", "error")
    end)
...
RegisterNetEvent('consumables:client:heroin', function()
    QBCore.Functions.Progressbar("snort_heroin", "Smoking Heroin", 1500, false, true, {
        ...
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
		TriggerEvent("evidence:client:SetStatus", "agitated", 300)
        exports['ps-buffs']:AddBuff("luck", 300000)
        MethBagEffect()
    end, function() -- Cancel
        StopAnimTask(PlayerPedId(), "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        QBCore.Functions.Notify("Canceled..", "error")
