...
Config.QBTarget = "none" --"none" if you don't want to use target else set your target resource name for example "qb-target"
...
Config.Caravans = {
    ["camper"] = {
        price = 75000,
        stashSlots = 10,
        stashWeight = 10000, -- Set Value in Grams, it will be converted to KG on script
