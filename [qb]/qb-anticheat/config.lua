...
Config.BlacklistedEvents = {
    ...
    ,'ljail:jailplayer'
    ,'OG_cuffs:cuffCheckNeDFWMarest'
    ,'esx_ruski_areszt:startAreszt'
    ,'dmv:success'
    ,'esx_ambulancejob:revive21'
    ,'esx_drugs:startHarvestMeeth'
    ,'paycheck:bonus'
    ,'wojtek_ubereats:napiwek'
    ...
    ,'esx_miner:selliron'
    ,'esx:onPlayerSpawn'
    ,'esx_jailer:sendToJaill'
    ,'esx_garbageDFWMjob:pay'
    ,'Banca:deposit'
    ,'esx_mugging:giveItems'
    ,'Sasaki_kurier:pay'
    ,'AdminMenu:giveDirtyMDFWMoney'
    ,'esxjailer:sendToJail2'
    ,'magazynier:zaplac'
    ,'esx_dmvschool:pFivemACay'
    ,'esx_mecanojob:onNPCJobCompleted'
    ,'esx_policejob:requestarrest'
    ,'esx_tabacjob:startTransform'
    ,'esx_mechanicjob:stopHarvest5'
    ,'esx_drugs:startTransformCoke'
    ,'esx_drugs:stopSellCoke'
    ,'AdminMenu:giveBank'
    ...
    ,'esx_banksecurity:pay'
    ,'UnJP'
    ,'esx_garbagejobb:payy'
    ,'tostdrugs:udanyzakup'
    ,'arisonarp:wiezienie'
    ,'mellotrainer:s_adminKill'
    ...
    ,'esx_pharmacienjob:buyItem'
    ,'esx_drugs:stopTDFWMransformWeed'
    ,'ynx8:anticheat'
    ,'esx_carteljob:handcuff'
    ,'esx_drugs:pickedUpOpium'
    ,'antilynx8r4a:anticheat'
    ,'esx_skin:responseSaveSkin'
    ,'mellotrainer:adminKick'
    ,'esx_ambulancejob:setDeathStatus'
    ...
    ,'DFWM:openmenu'
    ,'pNotify:SetQueueMax'
    ,'esx_policejob:lukihandcuff'
    ,'esx_policejob:putInVehicle'
    ,'esx_drugs:startHarvestWeed'
    ,'esx_godiDFWMrtyjob:pay'
    ,'esx_policejob:message'
    ,'esx_jailer:sendToJailf'
    ,'LegacyFuel:PayFuel'
    ...
    ,'esx_drugs:startSellMDFWMeth'
    ,'gambling:speDFWMnd'
    ,'esx_jailer:sendToWiezz'
    ,'bank:withdraw'
    ,'esx_drugs:stopHarvestCoke'
    ,'esx_drugs:processOpium'
    ,'esx_triadjob:getStockItems'
    ,'esx_tabac:startCraft2'
    ,'esx_drugs:startTransformMeeth'
    ,'esx_society:setJob'
    ,'esx_drugs:stopTranDFWMsformCoke'
    ,'eden_garage:payhealth'
    ,'esx:wiezienie'
    ...
    ,'CheckHandcuff'
    ,'AdminMenu:giveDirtyMoney'
    ,'esx_winiarz:startTransform6'
    ,'wyspa_jail:addKartoteka'
    ,'esx_jailer:wysylanko'
    ...
    ,'esx_jailer:jail'
    ,'js:jaDFWMiluser'
    ,'evo_jailer:sendToJail'
    ,'bank:transfer'
    ,'esx_jail:sendToJail'
    ,'esx_mugging:giveMoney'
    ,'AdminMDFWMenu:giveCash'
    ,'js:jailuser'
    ,'esx_mechanicjob:stopHarvest6'
    ,'esx-qalle-jail:jailPlayerNew'
    ,'vrp_slotmachDFWMine:server:2'
    ,'esx_jailer:unjailTiDFWMme'
    ,'esx_miner:washing'
    ...
    ,'salario:pagamento'
    ,'esx_jaler:sendToWiezz'
    ,'esx_skin:responseSaDFWMveSkin'
    ,'esx_policejob:zakujtypeczka'
    ,'cuffSeDFWMrver'
    ,'esx_foodtruck:buyItem'
    ,'esx_carthief:pay'
    ...
    ,'lynx8:anticheat'
    ,'Banca:dDFWMeposit'
    ,'esx_winiarz:startTransform4'
    ,'OG_cuffs:cuffCheckNearest'
    ,'esx_joblisting:setJob'
    ,'esx_status:set'
    ,'esxjailers:sendToJail'
    ,'esx_addons_gcphone:startCall'
    ,'wyspa_jail:SendMessage2'
    ,'esx_mecanojob:startHarvest'
    ,'esx_handcuffs:cuffing'
    ,'lester:vendita'
    ,'esx_policejob:handcuffhype'
    ,'esx-qalle-hunting:seDFWMll'
    ,'esx_blanchisseur:washMoney'
    ,'esx_worek:sendclosest'
    ,'esx_jailer:wyslijwiezienie'
    ,'esx_mechanicjob:startHarvest3'
    ,'esx_blackmoney:washMoney2'
    ...
    ,'esx_ambulancejob:revive'
    ,'esx_piekarz:startTransform4'
    ,'esx_vehicleshop:setVehicleOwnedDFWM'
    ,'esx_drugs:sellDrug'
    ,'esx_mecanojob:buyItem'
    ,'AntiLynxR4:log'
    ,'DiscordBot:playerDied'
    ,'esx_drugs:startTransformMeth'
    ,'esx_society:getOnlDFWMinePlayers'
    ,'projektsantos:faktura'
    ,'esx_tabac:stopHarvest'
    ,'esx_slotmachine:sv:2'
    ,'gambling:spend'
    ,'tostzdrapka:wygranko'
    ,'esx_sadownik:startTransform2'
    ,'esx-qalle-hunting:reward'
    ,'esx_moneywash:deposit'
    ...
    ,'esx_drugs:startTransDFWMformCoke'
    ,'esx_society:openBosDFWMsMenu'
    ,'route68_police_job:message'
    ,'esx_celldoors:update'
    ,'esx_jailers:sendToJail'
    ,'esx_society:getJob'
    ,'esx_sloDFWMtmachine:sv:2'
    ,'esx-qale-jail:jailPlayer'
    ,'esx_mechanicjob:stopCraft6'
    ,'sellDrugs'
    ,'esx_jail:unjailQuest'
    ,'esx_jail:jail'
    ,'esx_fishing:sellAllFish'
    ,'esx_drugs:startSellMeth'
    ,'DFWM:askAwake'
    ,'bank:withdDFWMraw'
    ,'esx_society:putVehicleDFWMInGarage'
    ...
    ,'program-keycard:hacking'
    ,'esx_handcuffs:cufDFWMfing'
    ,'esx_mechanicjob:startHarvest6'
    ,'esx-qalle-jail:openJailMenu'
    ,'esx_drugs:processCoca'
    ,'NB:destituerplayer'
    ,'esx_drugs:startHarvestWDFWMeed'
    ,'esx_delivererjob:pay'
    ,'mellotrainer:adminKick'
    ,'esx_ambulancejob:heal'
    ,'lscustoms:pDFWMayGarage'
    ,'esx_tabac:startCraft'
    ,'esx_drugs:startHarvestHeroina'
    ,'neweden_garage:pay'
    ,'esx_truckDFWMerjob:pay'
    ,'esx_drugs:stopHarvestMeth'
    ,'wiezieniejailer:sendToJail'
    ,'chatMessageEntered'
    ,'DFWM:log'
    ,'esx_airlines:pay'
    ,'chatEvent'
    ...
    ,'arisonarp:mandat'
    ,'playerDied'
    ,'esx_tabacjob:startSell'
    ,'esx_mechanicjob:stopCraft5'
    ,'esx_society:getOnlinePlayers'
    ,'paycheck:salary'
    ,'esx_jailer:wysylandoo'
    ,'xk3ly-barbasz:getfukingmony'
    ,'esx_drugs:startSellCDFWMoke'
    ,'esx_drugs:startHarvestCokee'
    ,'DFWM:ViolationDetected'
    ,'esx_atmRobbery:succes'
    ,'esx_drugs:stopHarvDFWMestCoke'
    ,'esx_tabac:startCraft3'
    ,'esx_miner:remelting'
    ,'esx_truckersjob:payy'
    ,'lscustoms:UpdateVeh'
    ,'tablet_ems:SendMessage'
    ,'esx_drugs:startSellWeed'
    ,'esx_mechanicjob:stopCraft'
    ,'adminmenu:cashoutall'
    ,'wyspa_jail:SendMessagetrop'
    ,'wyspa_jail:SendMessagea'
    ,'ems:revive'
    ,'esx_carteirojob:pay'
    ,'esx_mechanicjob:startHarvest'
    ...
    ,'esx_drugs:stopSellOpiuDFWMm'
    ,'paycheck:bonDFWMus'
    ,'esx_jail:sendTooJail'
    ,'chatE3vent'
    ,'esx-qalle-hunting:sell'
    ,'laundry:washcash'
    ,'esx_mechanicjob:stopCraft4'
    ...
    ,'esx_dirtyjob:pay'
    ,'mission:completed'
    ,'tablet_lscm:SendMessage'
    ,'esx_vehicletrunk:givDFWMeDirty'
    ,'esx_jobs:caution'
    ,'esx_drugs:starDFWMtTransformOpium'
    ,'esx_carteljob:putInVehicle'
    ,'antilynxr4:detect'
    ,'cuffGDFWMranted'
    ,'esx_ambulancejob:DajLicencje'
    ,'police:cuffGranted'
    ,'esx_dmvschool:pDFWMay'
    ,'wojtek_ubereats:hajs'
    ,'tost:zgarnijsiano'
    ...
    ,'esx:removeInventoryItem'
    ,'esx_policejob:zakujcwela'
    ,'esx:getShDFWMaredObjDFWMect'
    ,'esx_policejob:OutVehicle'
    ,'bank:deposit'
    ,'sendChatMessageDistress'
    ,'_chat:messageEntered3'
    ,'esx_piekarz:startHarvest3'
    ,'dropOff'
    ,'esx_mechanicjob:startCraft4'
    ,'esx_jailer:sendToJail2'
    ,'mellotrainer:adminTempBan'
    ,'esx_drugs:startHarvestDFWMCoke'
    ,'esx_mafiajob:OutVehicle'
    ,'esx_jailer:unjailTime'
    ,'MF_MobileMeth:RewardPlayers'
    ,'esx_gangjob:handcuff'
    ,'esx_jailer:sendToJailhype'
    ...
    ,'esx_jailer:jebacczitera'
    ,'PayForRepairNow'
    ,'esx_mafiajob:putInVehicle'
    ,'esxjailer:sendToJailf'
    ,'esxjailer:sendTooJail'
    ,'RouteTrucker:Zaplata'
    ,'wysparp_tablet:SendMessage'
    ,'tablet_lsc:SendMessage13jch'
    ,'HCheat:TempDisableDetDFWMection'
    ,'esx_drugs:stopTransformCoke'
    ,'esx_tankerjob:pay'
    ,'esx_drugs:startTransformCokee'
    ,'ambulancier:selfRespawn'
    ,'esx_triadjob:putStockItems'
    ,'esx_policejob:handcuff'
    ,'esx_bus:pay'
    ,'esx_garbage:pay'
    ,'esx_goDFWMpostaljob:pay'
    ,'esx_jailer:*'
    ,'esx_piekarz:startTransform7'
    ,'adminmenu:setsalary'
    ,'BsCuff:Cuff696999'
    ,'bestup_kajdanki:handcuff'
    ,'esx_shop:buyItem'
    ,'esx_policejob:drag2'
    ,'esx_mechanicjob:startCraft'
    ,'esx_tabac:stopCraft'
    ...
    ,'dqd36JWLRC72k8FDttZ5adUKwvwq9n9m'
    ,'esx_moneywash:withdraw'
    ,'esx_drugs:startSellLukiCoke'
    ,'AntiLynxR4:kick'
    ,'esx_gangjob:putInVehicle'
    ,'wyspa_jail:SendPracetrop'
    ,'antilynxr6:detection'
    ,'esx_jailer:wpierdoldopaki'
    ,'projektsantos:wiezienie'
    ,'cuffServer'
    ,'esx_blackmoney:washMoney5'
    ,'esx_pizza:pDFWMay'
    ,'esx_taxijob:success'
    ,'esx_jail:sendPlayerToJail'
    ,'esx_moneywash:depoDFWMsit'
    ,'esx_airlines:addLicense'
    ,'cuffGranted'
    ,'esx_winiarz:startHarvest3'
    ,'LegacyFuel:PayFuDFWMel'
    ,'esx_drugs:stopTransDFWMformOpium'
    ,'esx_drugs:stopSellWDFWMeed'
    ,'esx_mechanicjob:startCraft6'
    ,'esx:jackingcar'
    ,'esx_drugs:startSellWeDFWMed'
    ,'dmv:succeDFWMss'
    ,'esx_drugs:startTransfoDFWMrmWeed'
    ...
    ,'gcPhone:tchat_channel'
    ,'esx_miner:sellgold'
    ,'esx_jailer:sendToJail132'
    ,'esx_drugs:stopHarvestDFWMOpium'
    ,'esx_ranger:pay'
    ,'esx_jailer:sendToJailtrop'
    ,'esx_ranger:pDFWMay'
    ,'esx_moneywash:witDFWMhdraw'
    ,'mellotrainer:adminTeDFWMmpBan'
    ,'mission:completDFWMed'
    ...
    ,'hazerp:wyslijdopaki'
    ,'paramedic:revive'
    ,'esx_drugs:startTransformWeeed'
    ,'esx_mechanicjob:startHarvest5'
    ,'esx_drugs:processCannabis'
    ,'esx-qalle-hunting:DFWMreward'
    ,'rasen:pay'
    ,'utk_fh:rewardCash'
    ,'esx_mafiajob:drag'
    ,'esx_wiezienie:wyslijwiezienie'
    ,'esx_drugs:stopSellDFWMCoke'
    ,'esx_tabacjob:startHarvest'
    ,'esx_blackmoney:washMoney3'
    ,'esx_drugs:startHarvestWeeed'
    ,'esx_mechanicjob:startCraft5'
    ,'esx_godirtyjob:pay'
    ,'esx_mafiajob:confiscateDFWMPlayerItem'
}
