...
AddEventHandler( 'wk:toggleRadar', function()
    ...
    if ( IsPedSittingInAnyVehicle( ped ) ) then 
        ...
        if ( GetVehicleClass( vehicle ) == 18 ) then
            ...
            QBCore.Functions.Notify('You Are Not In Police Vehicle', 'error')
        end 
    else 
        QBCore.Functions.Notify('You Should Be In Vehicle', 'error')
    end 
end )
...
function ToggleSpeedType()
    if ( radarInfo.speedType == "mph" ) then 
        ...
        QBCore.Functions.Notify('Changed To KM/H', 'success')
    else 
        radarInfo.speedType = "mph"
        QBCore.Functions.Notify('Changed To M/H', 'success')
    end
end 
