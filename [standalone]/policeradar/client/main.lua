    ...
    while true do 
        ...
        if QBCore ~= nil then 
            ...
            if ( IsDisabledControlPressed( 0, Keys["LEFTCTRL"] ) and IsDisabledControlJustPressed( 0, Keys["7"] ) ) then 
                if (QBCore.Functions.GetPlayerData().job.name == "police" or QBCore.Functions.GetPlayerData().job.name == "sheriff") and QBCore.Functions.GetPlayerData().job.onduty then
