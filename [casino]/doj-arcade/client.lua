...
local arcade= {
  ...
  {-1658.66, -1061.99, 11.16     ,"Arcade",234.39,0x72551375,"cs_lifeinvad_01"},
  {946.53, 15.33, 115.16     ,"Arcade",61.19,0x72551375,"cs_lifeinvad_01"},
}
Citizen.CreateThread(function()
...
exports['qb-target']:AddBoxZone("arcadeabas", vector3(941.7, 7.55, 116.16), 2.6, 3, {
    name="arcadeabas",
    heading=15,
    --debugPoly=true,
    minZ=113.36,
...
exports['qb-target']:AddBoxZone("arcedbabat", vector3(943.84, 21.13, 116.16), 1.2, 1, {
    name="arcedbabat",
    heading=60,
    --debugPoly=true,
    minZ=113.36,
