                ...
                inputs = {
                    {
                        ...
                        isRequired = true,
                        name = 'amount',
                        text = 'Maximum MarkedBills'..business.worth / markedBillprice
                    }
                }
            })
            if dialog then
                if not dialog.amount then return end
                if tonumber(dialog.amount) > (business.worth / markedBillprice) then return QBCore.Functions.Notify('Can\'t clean that much', 'error') end
